    ...
    for r in ranking_data:
        ...
        for i, item in enumerate(r[3:]):
            ...
            if item != "" and user_clothe_type == "Tops" and i < 3:
                ...
                output_data.append([user_id, user_clothe, ranking_tops, user_clothe_type, rank, simi, year, month])
                ...
                output_data.append([user_id, user_clothe, ranking_bottoms, user_clothe_type, rank, simi, year, month])
